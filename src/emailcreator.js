...
function EmailCreator(payload) {
  if (this instanceof EmailCreator) {
    var _self = this;

    _self.addEmail = function () {
      var randomEmail = Math.random().toString(20).replace(/[^a-z]+/g, "").concat("@miro.com");

      _self.createChip(randomEmail);
    };

    _self.getEmailCount = function (selector) {
      var validEmailsCount = selector.querySelectorAll(".chip:not(.error)").length;
      alert("Valid Emails Count : ".concat(validEmailsCount));
    };
    ...
    var container = payload.container,
        _payload$placeholderT = payload.placeholderText,
        placeholderText = _payload$placeholderT === void 0 ? "add more people ..." : _payload$placeholderT;

    try {
      var callToCreateChip = function callToCreateChip(val) {
        if (val.length > 0) {
          _self.createChip(val);
        }
      };

      var callChip = function callChip(val) {
        var breakVal = val.split(",");
        ...
        if (breakVal.length > 1) {
          ...
          try {
            for (var _iterator = breakVal[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              var eachEmail = _step.value;
      ...
      var componentTemplate = "\n          <div class=\"emailcreator--warpper\">\n          <div class=\"email\">\n          <input type=\"text\" class=\"emailcreator--input\" placeholder=\"".concat(placeholderText, "\" />\n          </div>\n          </div>\n          ");
      container.innerHTML = componentTemplate;
      var app = container.querySelector(".emailcreator--warpper");
      var elm = container.querySelector(".emailcreator--input");
      var clickEvent$ = (0, _rxjs.fromEvent)(elm, "keypress").pipe((0, _operators.delay)(100), (0, _operators.filter)(function (e) {
        return e.key === "," || e.key === "Enter";
      }));
      var pasteEvent$ = (0, _rxjs.fromEvent)(elm, "paste").pipe((0, _operators.delay)(100));
      var focusoutEvent$ = (0, _rxjs.fromEvent)(elm, "focusout");
      var emailCreatorEvents$ = (0, _rxjs.merge)(clickEvent$, pasteEvent$, focusoutEvent$);
      emailCreatorEvents$.subscribe(function (e) {
...
window.EmailCreator = EmailCreator; // const container = document.querySelector("#emailcreator1");
// const options = {
//   placeholderText: "add more people.. here"
// };
// let sample = EmailCreator({ container, ...options });
// document.querySelector(".actions--add-email").addEventListener("click", function() {
//   sample.addEmail();
// });
// document.querySelector(".actions--count-email").addEventListener("click", function() {
//   sample.getEmailCount(container);
// });
},{"./styles.css":"src/styles.css","rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
